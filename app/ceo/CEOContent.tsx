...
const career = [
  ...
  },
  {
    ...
    description: `コンサル在籍中に副業として株式会社NINJAを創業し、代表取締役に就任。デジタルイノベーション事業とヒューマンケア事業の2軸で事業を立ち上げる。デジタルイノベーション事業部では、生成AIを活用した新規事業案レポートメディア「ビズAI」の企画・開発・運営を主導し、リリース初月で1,000PVを達成。ヒューマンケア事業部では、自身のサッカー経験を活かし、育成年代サッカー情報メディア「育成年代サッカー.com」を立ち上げ、SEO戦略により検索流入を月間5,000PVまで成長させる。さらに、サッカー・野球のパーソナルトレーニングサービス「DOTS Personal」を開始し、法人向け福利厚生プランの営業・契約締結までを担当。2025年12月にはSNS事業部を新設し、企業のSNSマーケティング支援事業を開始。創業半年で3事業部体制を構築し、売上・組織の両面で事業基盤を確立。`,
  },
  {
    period: "2026年1月",
